<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h2 class="font-bold text-2xl text-slate-800 dark:text-slate-100 leading-tight">{{ __('Nouvelle opportunité') }}</h2>
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Publiez une nouvelle offre de stage ou d'emploi.</p>
            </div>
                ...
                <form method="POST" action="{{ route('opportunities.store') }}" class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="title" type="text" class="mt-1 block w-full" :value="old('title')" required autofocus placeholder="Ex: Stage Développeur Web Fullstack Laravel" />
                        ...
                        <div class="grid sm:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="type" name="type" type="text" class="mt-1 block w-full" :value="old('type')" placeholder="Ex: Stage, CDD, CDI" />
                        ...
                        <div class="grid sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="profil_requis" name="profil_requis" type="text" class="mt-1 block w-full" :value="old('profil_requis')" placeholder="Ex: PHP, Javascript, MySQL" />
